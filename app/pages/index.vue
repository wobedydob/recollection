...
const { ideas, tags, isLoading: isLoadingIdeas, loadData, addIdea, updateIdea, deleteIdea, createTag, deleteTag, filterByTag, getTagById, getIdeaById } = useIdeas()
...
function handleSubmit() {
  ...
  addIdea(newIdeaContent.value, newIdeaTagIds.value)
